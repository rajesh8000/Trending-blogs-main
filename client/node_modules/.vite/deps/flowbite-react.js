import {
  require_classnames
} from "./chunk-IHUM5NDH.js";
import {
  require_jsx_runtime
} from "./chunk-QFXQQHX7.js";
import {
  require_react_dom
} from "./chunk-WUROFKGV.js";
import {
  require_react
} from "./chunk-OQO2KF6W.js";
import {
  __commonJS,
  __publicField,
  __toESM
...
function Popover({ children, content, theme: customTheme = {}, arrow: arrow4 = true, trigger = "click", initialOpen, open: controlledOpen, onOpenChange: setControlledOpen, placement: theirPlacement = "bottom", ...props }) {
  const [uncontrolledOpen, setUncontrolledOpen] = (0, import_react37.useState)(Boolean(initialOpen));
  const arrowRef = (0, import_react37.useRef)(null);
  ...
  if (!(0, import_react37.isValidElement)(children)) {
    throw Error("Invalid target element");
  }
  const target = (0, import_react37.useMemo)(() => {
    return (0, import_react37.cloneElement)(children, getReferenceProps({
      ref,
      "data-testid": "flowbite-popover-target",
      ...children == null ? void 0 : children.props
    }));
  }, [children, ref, getReferenceProps]);
  return (0, import_jsx_runtime63.jsxs)(import_jsx_runtime63.Fragment, { children: [target, open && (0, import_jsx_runtime63.jsx)(FloatingFocusManager, { context, modal: true, children: (0, import_jsx_runtime63.jsx)("div", { className: theme2.base, ref: refs.setFloating, "data-testid": "flowbite-popover", ...props, style: floatingStyles, ...getFloatingProps(), children: (0, import_jsx_runtime63.jsxs)("div", { className: "relative", children: [arrow4 && (0, import_jsx_runtime63.jsx)("div", { className: theme2.arrow.base, "data-testid": "flowbite-popover-arrow", ref: arrowRef, style: {
    top: arrowY ?? " ",
    left: arrowX ?? " ",
    right: " ",
    bottom: " ",
    [getArrowPlacement({ placement })]: theme2.arrow.placement
  }, children: " " }), (0, import_jsx_runtime63.jsx)("div", { className: theme2.content, children: content })] }) }) })] });
}
...
var Radio = (0, import_react39.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
...
var RangeSlider = (0, import_react40.forwardRef)(({ className, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var RatingContext = (0, import_react41.createContext)(void 0);
function useRatingContext() {
  const context = (0, import_react41.useContext)(RatingContext);
  if (!context) {
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime68.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size3], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size3 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime69.jsx)(RatingContext.Provider, { value: { theme: theme2, size: size3 }, children: (0, import_jsx_runtime69.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var Floating = ({ animation = "duration-300", arrow: arrow4 = true, children, className, content, placement = "top", style = "dark", theme: theme2, trigger = "hover", minWidth, ...props }) => {
  const arrowRef = (0, import_react44.useRef)(null);
...
var SidebarContext = (0, import_react45.createContext)(void 0);
function useSidebarContext() {
  const context = (0, import_react45.useContext)(SidebarContext);
  if (!context) {
...
var SidebarItemContext = (0, import_react46.createContext)(void 0);
function useSidebarItemContext() {
  const context = (0, import_react46.useContext)(SidebarItemContext);
  if (!context) {
...
var SidebarCollapse = ({ children, className, icon: Icon, label, chevronIcon: ChevronIcon = HiChevronDown, renderChevronIcon, open = false, theme: customTheme = {}, ...props }) => {
  ...
  const [isOpen, setOpen] = (0, import_react47.useState)(open);
  const { theme: rootTheme, isCollapsed } = useSidebarContext();
  const theme2 = mergeDeep(rootTheme.collapse, customTheme);
  (0, import_react47.useEffect)(() => setOpen(open), [open]);
...
var SidebarCTA = ({ children, color = "info", className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime74.jsx)("div", { "data-testid": "sidebar-cta", hidden: isCollapsed, className: twMerge(theme2.base, theme2.color[color], className), ...props, children });
};
...
var TableBodyContext = (0, import_react50.createContext)(void 0);
function useTableBodyContext() {
  const context = (0, import_react50.useContext)(TableBodyContext);
  if (!context) {
...
var TableContext = (0, import_react51.createContext)(void 0);
function useTableContext() {
  const context = (0, import_react51.useContext)(TableContext);
  if (!context) {
...
// node_modules/flowbite-react/lib/esm/components/Table/TableBody.js
var TableBody = (0, import_react52.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
var TableCell = (0, import_react53.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
var TableHeadContext = (0, import_react54.createContext)(void 0);
function useTableHeadContext() {
  const context = (0, import_react54.useContext)(TableHeadContext);
  if (!context) {
...
// node_modules/flowbite-react/lib/esm/components/Table/TableHead.js
var TableHead = (0, import_react55.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
  const { theme: rootTheme } = useTableContext();
...
var TableHeadCell = (0, import_react56.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
var TableRow = (0, import_react57.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
// node_modules/flowbite-react/lib/esm/components/Table/Table.js
var TableComponent = (0, import_react58.forwardRef)(({ children, className, striped, hoverable, theme: customTheme = {}, ...props }, ref) => {
...
var TabsComponent = (0, import_react59.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(getTheme().tabs, customTheme);
  const id = (0, import_react59.useId)();
  const tabs = (0, import_react59.useMemo)(() => import_react59.Children.map(import_react59.Children.toArray(children), ({ props: props2 }) => props2), [children]);
  const tabRefs = (0, import_react59.useRef)([]);
  const [activeTab, setActiveTab] = (0, import_react59.useState)(Math.max(0, tabs.findIndex((tab) => tab.active)));
  const [focusedTab, setFocusedTab] = (0, import_react59.useState)(-1);
  ...
  return (0, import_jsx_runtime87.jsxs)("div", { className: twMerge(theme2.base, className), children: [(0, import_jsx_runtime87.jsx)("div", { "aria-label": "Tabs", role: "tablist", className: twMerge(theme2.tablist.base, theme2.tablist.styles[style], className), ...props, children: tabs.map((tab, index3) => (0, import_jsx_runtime87.jsxs)("button", { type: "button", "aria-controls": `${id}-tabpanel-${index3}`, "aria-selected": index3 === activeTab, className: twMerge(theme2.tablist.tabitem.base, tabItemStyle.base, index3 === activeTab && tabItemStyle.active.on, index3 !== activeTab && !tab.disabled && tabItemStyle.active.off), disabled: tab.disabled, id: `${id}-tab-${index3}`, onClick: () => handleClick({ target: index3 }), onKeyDown: (event) => handleKeyboard({ event, target: index3 }), ref: (element) => tabRefs.current[index3] = element, role: "tab", tabIndex: index3 === focusedTab ? 0 : -1, style: { zIndex: index3 === focusedTab ? 2 : 1 }, children: [tab.icon && (0, import_jsx_runtime87.jsx)(tab.icon, { className: theme2.tablist.tabitem.icon }), tab.title] }, index3)) }), (0, import_jsx_runtime87.jsx)("div", { className: twMerge(theme2.tabitemcontainer.base, tabItemContainerStyle), children: tabs.map((tab, index3) => (0, import_jsx_runtime87.jsx)("div", { "aria-labelledby": `${id}-tab-${index3}`, className: theme2.tabpanel, hidden: index3 !== activeTab, id: `${id}-tabpanel-${index3}`, role: "tabpanel", tabIndex: 0, children: tab.children }, index3)) })] });
});
...
var Textarea = (0, import_react60.forwardRef)(({ className, color = "gray", helperText, shadow, theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(getTheme().textarea, customTheme);
  return (0, import_jsx_runtime88.jsxs)(import_jsx_runtime88.Fragment, { children: [(0, import_jsx_runtime88.jsx)("textarea", { ref, className: twMerge(theme2.base, theme2.colors[color], theme2.withShadow[shadow ? "on" : "off"], className), ...props }), helperText && (0, import_jsx_runtime88.jsx)(HelperText, { color, children: helperText })] });
});
...
var ThemeModeScript = ({ mode, ...others }) => {
  return (0, import_jsx_runtime89.jsx)("script", { ...others, "data-flowbite-theme-mode-script": true, dangerouslySetInnerHTML: {
...
var TimelineContentContext = (0, import_react61.createContext)(void 0);
function useTimelineContentContext() {
  const context = (0, import_react61.useContext)(TimelineContentContext);
  if (!context) {
...
var TimelineContext = (0, import_react62.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react62.useContext)(TimelineContext);
  if (!context) {
...
var TimelineItemContext = (0, import_react63.createContext)(void 0);
function useTimelineItemContext() {
  const context = (0, import_react63.useContext)(TimelineItemContext);
  if (!context) {
...
var ToastContext = (0, import_react64.createContext)(void 0);
function useToastContext() {
  const context = (0, import_react64.useContext)(ToastContext);
  if (!context) {
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react65.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react65.useState)(false);
...
var ToggleSwitch = (0, import_react66.forwardRef)(({ checked, className, color = "blue", sizing = "md", disabled, label, name, onChange, theme: customTheme = {}, ...props }, ref) => {
  const id = (0, import_react66.useId)();
